...
* Apply an initial JSCS configuration based on the [jQuery style guide](https://contribute.jquery.org/style-guide/js/). All JavaScript code must now conform to these standards. See #348.
